...
The current component model applies heat into top board cells under the component footprint and estimates junction temperature afterward:

```text
T_junction = T_board_max_under_component + power * R_th
```
