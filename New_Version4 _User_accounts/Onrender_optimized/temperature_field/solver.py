...
def _component_reports(
    ...
    for component in config.components:
        ...
        case_to_ambient_rth = (
            component.case_to_ambient_thermal_resistance_k_per_w
            if component.case_to_ambient_thermal_resistance_k_per_w is not None
            else 0.0
        )
        ...
        if component.thermal_resistance_mode == "junction_to_case":
            total_rth += case_to_ambient_rth
            component_model = "surface_heat_flux_plus_rth_jc_and_rth_ca"
